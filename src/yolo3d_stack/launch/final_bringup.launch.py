...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # ====================================================
        # NEW: PLANNER & CONTROLLER
        # ====================================================
        
        # Planner Server (Calculates the path - The Green Line)
        Node(
        ...
        # Controller Server (Follows the path - The Thrusters)
        Node(
            ...
            output='screen',
            parameters=[nav2_params],
            remappings=[('cmd_vel', '/cmd_vel')] # Ensure this matches your thruster driver
        ),

        # BT Navigator (The "Captain" - Orchestrates the mission)
        Node(
        ...
        # Behavior Server (Recovery behaviors like "Back up" or "Spin")
        Node(
